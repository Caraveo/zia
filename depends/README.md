...
ZiaCoin Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring ZiaCoin Core

**When configuring ZiaCoin Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring ZiaCoin Core:
...
variables will be set when generating the ZiaCoin Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
