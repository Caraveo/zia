...
```sh
DOCKER_BUILDKIT=1 docker build -t ziacoin-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/ziacoin -it ziacoin-linter
```
...
maintained:
* for `src/secp256k1`: https://github.com/ziacoin-core/secp256k1.git (branch master)
* for `src/leveldb`: https://github.com/ziacoin-core/leveldb-subtree.git (branch ziacoin-fork)
* for `src/crypto/ctaes`: https://github.com/ziacoin-core/ctaes.git (branch master)
* for `src/crc32c`: https://github.com/ziacoin-core/crc32c-subtree.git (branch ziacoin-fork)
* for `src/minisketch`: https://github.com/ziacoin-core/minisketch.git (branch master)

To do so, add the upstream repository as remote:

```
git remote add --fetch secp256k1 https://github.com/ziacoin-core/secp256k1.git
```
