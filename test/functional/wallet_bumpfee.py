...
class BumpFeeTest(ZiaCoinTestFramework):
    ...
    def test_invalid_parameters(self, rbf_node, peer_node, dest_address):
        ...
        for mode in ["foo", Decimal("3.1415"), "sat/B", "ZIA/kB"]:
...
def test_dust_to_fee(self, rbf_node, dest_address):
    ...
    # The DER formatting used by ZiaCoin to serialize ECDSA signatures means that signatures can have a
    ...
    # Expected fee is 141 vbytes * fee_rate 0.00350250 ZIA / 1000 vbytes = 0.00049385 ZIA.
    # or occasionally 140 vbytes * fee_rate 0.00350250 ZIA / 1000 vbytes = 0.00049035 ZIA.
    # Dust should be dropped to the fee, so actual bump fee is 0.00050000 ZIA.
...
def test_maxtxfee_fails(self, rbf_node, dest_address):
    ...
    # expected bump fee of 141 vbytes * 0.00200000 ZIA / 1000 vbytes = 0.00002820 ZIA
...
def test_watchonly_psbt(self, peer_node, rbf_node, dest_address):
    ...
    # Ensure the payment amount + change can be fully funded using one of the 0.001ZIA inputs.
