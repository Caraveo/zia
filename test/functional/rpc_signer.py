...
Verify that a ziacoind node can use an external signer command.
...
class RPCSignerTest(ZiaCoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart ziacoind with -signer=<cmd>',
