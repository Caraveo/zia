#!/usr/bin/env python3
# Copyright (c) 2019-2022 The ZiaCoin Core developers
...
class TestShell:
    """Wrapper Class for ZiaCoinTestFramework.

    The TestShell class extends the ZiaCoinTestFramework
    ...
    class __TestShell(ZiaCoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by ZiaCoinTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # ZiaCoinTestFramework instances are supposed to be constructed with the path
