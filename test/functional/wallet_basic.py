...
class WalletTest(ZiaCoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 ZIA from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 ZIA with subtract fee from amount
        ...
        # Sendmany 10 ZIA with subtract fee from amount
        ...
        # Sendmany 5 ZIA to two addresses with subtracting fee from both addresses
