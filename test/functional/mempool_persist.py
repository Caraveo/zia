...
By default, ziacoind will dump mempool on shutdown and
...
class MempoolPersistTest(ZiaCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent ziacoind from writing mempool.dat to disk. Verify that `savemempool` fails")
