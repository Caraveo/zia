#!/usr/bin/env python3
# Copyright (c) 2020-present The ZiaCoin Core developers
...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The ziacoind node closes feeler connections as soon as a version
...
class P2PAddConnections(ZiaCoinTestFramework):
    ...
    def run_test(self):
        ...
        # ziacoind behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that ziacoind sends its own version prior to processing
