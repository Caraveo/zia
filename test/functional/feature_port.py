#!/usr/bin/env python3
# Copyright (c) 2024-present The ZiaCoin Core developers
...
class PortTest(ZiaCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("When starting with -port, ziacoind binds to it and uses port + 1 for an onion bind")
