...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the ZiaCoinTestFramework
    pass


class ExampleTest(ZiaCoinTestFramework):
    # Each functional test is a subclass of the ZiaCoinTestFramework class.
    ...
    def custom_method(self):
        ...
        ZiaCoinTestFramework class so other tests can use it."""
