...
class ZiaCoinChainstateTest(ZiaCoinTestFramework):
    def skip_test_if_missing_module(self):
        self.skip_if_no_ziacoin_chainstate()
    ...
    def run_test(self):
        ...
        self.log.info(f"Testing ziacoin-chainstate {self.get_binaries().chainstate_argv()} with datadir: {datadir}")
...
if __name__ == "__main__":
    ZiaCoinChainstateTest(__file__).main()
