...
# TestP2PConn: A peer we use to send messages to ziacoind, and store responses.
...
class CompactBlocksTest(ZiaCoinTestFramework):
    ...
    # This test actually causes ziacoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that ziacoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for ziacoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # ziacoind will not send blocktxn responses for blocks whose height is
