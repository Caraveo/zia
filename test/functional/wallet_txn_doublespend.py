...
class TxnMallTest(ZiaCoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 ZIA:
        ...
        # First: use raw transaction API to send 1240 ZIA to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 ZIA coin each
        ...
        # Node0's balance should be starting balance, plus 50ZIA for another
        ...
        # Node0's total balance should be starting balance, plus 100ZIA for
