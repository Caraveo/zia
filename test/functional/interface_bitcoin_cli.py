#!/usr/bin/env python3
# Copyright (c) 2017-2022 The ZiaCoin Core developers
...
# The block reward of coinbaseoutput.nValue (50) ZIA/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 ZIA/block.
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"ziacoin-cli -h\" for help or \"ziacoin-cli listwallets\" to see "
...
class TestZiaCoinCli(ZiaCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `ziacoin-cli getblockchaininfo`")
        ...
        # Prevent ziacoin-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and ziacoin-cli return all proxies")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and ziacoin-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (ZIA/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (ZIA/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 ZIA) to the default wallet.
            ...
            # Test ziacoin-cli -generate with -rpcwallet in multiwallet mode.
