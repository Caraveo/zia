#!/usr/bin/env python3
# Copyright (c) 2019-2021 The ZiaCoin Core developers
...
class TxDownloadTest(ZiaCoinTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new ziacoind instances, as setting mocktimes has long-term effects on when
