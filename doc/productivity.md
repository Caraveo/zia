...
```sh
cmake --build build --target ziacoind ziacoin-cli
cmake --build build --target ziacoin-qt
cmake --build build --target bench_ziacoin
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:ziacoin/ziacoin.git
```
