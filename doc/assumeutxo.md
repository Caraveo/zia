...
Assumeutxo is a feature that allows fast bootstrapping of a validating ziacoind
instance.
...
```
$ ziacoin-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ ziacoin-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
