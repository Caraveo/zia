# PSBT Howto for ZiaCoin Core

Since ZiaCoin Core 0.17, an RPC interface exists for Partially Signed ZiaCoin
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/ziacoin/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for ZiaCoin transactions that are not fully signed
...
#### Multisig with multiple ZiaCoin Core instances
