...
By default, ZiaCoin Core allows up to 125 connections to different peers, 11 of
...
limits are tiny. Keep in mind that ziacoin's trustless model works best if you are
