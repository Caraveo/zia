UNIX BUILD NOTES
====================
Some notes on how to build ZiaCoin Core in Unix.
...
memory available when compiling ZiaCoin Core. On systems with less, gcc can be
...
To build ZiaCoin Core without wallet, see [*Disable-wallet mode*](#disable-wallet-mode)
...
Disable-wallet mode
--------------------
When the intention is to only run a P2P node, without a wallet, ZiaCoin Core can
