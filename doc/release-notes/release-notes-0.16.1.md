ZiaCoin Core version 0.16.1 is now available from:

  <https://ziacoincore.org/bin/ziacoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting ziacoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure ziacoind processes are cleaned up when tests end (sdaftuar)
