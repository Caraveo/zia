ZiaCoin Core version 0.9.4 is now available from:

  https://ziacoin.org/bin/0.9.4/
...
this update is incompatible with the ZiaCoin system and could lead to consensus
forks.

ZiaCoin Core released binaries from https://ziacoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~ziacoin/+archive/ubuntu/ziacoin
- A third-party or self-compiled ZiaCoin Core

upgrade to ZiaCoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
