ZiaCoin Core version 27.0 is now available from:

  <https://ziacoincore.org/bin/ziacoin-core-27.0/>
...
- libziacoinconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libziacoinkernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build ZiaCoin Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of ZiaCoin Core would
