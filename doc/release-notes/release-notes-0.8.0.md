ZiaCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/ziacoin/files/ZiaCoin/ziacoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the ZiaCoin
...
New/changed settings (command-line or ziacoin.conf file)
--------------------------------------------------------
