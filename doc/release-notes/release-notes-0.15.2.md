ZiaCoin Core version *0.15.2* is now available from:

  <https://ziacoincore.org/bin/ziacoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in ziacoin-tx (TheBlueMatt)
