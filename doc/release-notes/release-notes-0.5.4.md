ZiaCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/ziacoin/files/ZiaCoin/ziacoin-0.5.4/
...
http://gitorious.org/ziacoin/ziacoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix ZiaCoin-Qt notifications under Growl 1.3.
Increase required age of ZiaCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxZiaCoin properly when installing ZiaCoin-Qt over it. (Windows)
