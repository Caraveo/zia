ZiaCoin Core version 0.9.2.1 is now available from:

  https://ziacoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 ZIA to 0.01 ZIA
...
- Fix "Start ziacoin on system login"
