ZiaCoin Core version 0.13.2 is now available from:

  <https://ziacoin.org/bin/ziacoin-core-0.13.2/>
...
- #8908 `4a974b2` Update ziacoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow ziacoin-tx to create v2 transactions (btcdrak)
