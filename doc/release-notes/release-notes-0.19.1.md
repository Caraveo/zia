...
ZiaCoin Core version 0.19.1 is now available from:

  <https://ziacoincore.org/bin/ziacoin-core-0.19.1/>
...
From ZiaCoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as ZiaCoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, ZiaCoin Core does not yet change appearance when
...
- #17488 fix "ziacoind already running" warnings on macOS (fanquake)
