ZiaCoin Core version 0.10.4 is now available from:

  <https://ziacoin.org/bin/ziacoin-core-0.10.4/>
...
- #6953 `43c2789` Split ziacoin-tx into its own package
- #6953 `dfe0d4d` Include ziacoin-tx binary on Debian/Ubuntu
