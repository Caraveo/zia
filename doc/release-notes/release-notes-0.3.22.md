Download URL: https://sourceforge.net/projects/ziacoin/files/ZiaCoin/ziacoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 ZIA fee schedule (users still pay 0.01 ZIA per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #ziacoin00 - #ziacoin99
