...
This guide describes how to build ziacoind, command-line utilities, and GUI on NetBSD.
...
It is not necessary to build wallet functionality to run ziacoind or the GUI.

###### Descriptor Wallet Support

`sqlite3` is required to enable support for [descriptor wallets](https://github.com/ziacoin/ziacoin/blob/master/doc/descriptors.md).
...
There are many ways to configure ZiaCoin Core. Here is an example that
