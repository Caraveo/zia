...
{
    BOOST_CHECK(TestSplitHost("www.ziacoincore.org", "www.ziacoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.ziacoincore.org]", "www.ziacoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.ziacoincore.org:80", "www.ziacoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.ziacoincore.org]:80", "www.ziacoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.ziacoincore.org:65536", "www.ziacoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.ziacoincore.org:0", "www.ziacoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.ziacoincore.org:", "www.ziacoincore.org:", 0, false));
}
