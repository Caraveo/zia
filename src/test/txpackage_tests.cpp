...
BOOST_AUTO_TEST_CASE(package_cpfp_tests)
{
    ...
    // Now that the child's fees have "increased" by 1 ZIA, the cheap package should succeed.
    {
    ...
    // Parent pays 1 ZIA and child pays none. The parent should be accepted without the child.
    {
        BOOST_CHECK_EQUAL(m_node.mempool->size(), expected_pool_size);
