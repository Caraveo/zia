...
#include <algorithm>
#include <attributes.h> // Added for ZiaCoin Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for ZiaCoin Core
#include <util/string.h> // Added for ZiaCoin Core
...
// Added for ZiaCoin Core. Similar to std::runtime_format from C++26.
...
// Added for ZiaCoin Core. Wrapper for checking format strings at compile time.
