...
std::optional<ConfigError> InitConfig(ArgsManager& args, SettingsAbortFn settings_abort_fn)
{
    try {
        ...
        // ziacoin.conf file just ignores the other file.)
        ...
        if (!fs::exists(base_path)) {
            ...
            // in https://github.com/ziacoin/ziacoin/issues/16220 about ways to
        ...
        // Show an error or warn/log if there is a ziacoin.conf file in the
