...
/** Interface from Qt to configuration data structure for ZiaCoin client.
...
public:
    ...
    ZiaCoinUnit getDisplayUnit() const { return m_display_ziacoin_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSZIAontrols() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    ZiaCoinUnit m_display_ziacoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(ZiaCoinUnit unit);
