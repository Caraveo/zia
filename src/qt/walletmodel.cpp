...
WalletModel::SendCoinsReturn WalletModel::prepareTransaction(WalletModelTransaction &transaction, const CCoinControl& coinControl)
{
    ...
    for (const SendCoinsRecipient &rcp : recipients)
    {
        ...
        {   // User-entered ziacoin address / amount:
...
void WalletModel::sendCoins(WalletModelTransaction& transaction)
{
...

    {
        ...
        {
            if (!rcp.message.isEmpty()) // Message from normal ziacoin:URI (ziacoin:123...?message=example)
...
bool WalletModel::bumpFee(Txid hash, Txid& new_hash)
{
    ...
    questionString.append(ZiaCoinUnits::formatHtmlWithUnit(getOptionsModel()->getDisplayUnit(), old_fee));
    questionString.append("</td></tr><tr><td>");
    questionString.append(tr("Increase:"));
    questionString.append("</td><td>");
    questionString.append(ZiaCoinUnits::formatHtmlWithUnit(getOptionsModel()->getDisplayUnit(), new_fee - old_fee));
    questionString.append("</td></tr><tr><td>");
    questionString.append(tr("New fee:"));
    questionString.append("</td><td>");
    questionString.append(ZiaCoinUnits::formatHtmlWithUnit(getOptionsModel()->getDisplayUnit(), new_fee));
    ...
    const bool always_show_unsigned{getOptionsModel()->getEnablePSZIAontrols()};
