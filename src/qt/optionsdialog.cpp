      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->ziacoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->ziacoinAtStartup);
    ...
    ui->ziacoinAtStartup->setToolTip(ui->ziacoinAtStartup->toolTip().arg(CLIENT_NAME));
    ui->ziacoinAtStartup->setText(ui->ziacoinAtStartup->text().arg(CLIENT_NAME));

    ui->openZiacoinConfButton->setToolTip(ui->openZiacoinConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new ZiaCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->ziacoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSZIAontrols);
...
void OptionsDialog::on_openZiaCoinConfButton_clicked()
{
