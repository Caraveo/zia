...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, ZiaCoinUnits::SeparatorStyle separators=ZiaCoinUnits::SeparatorStyle::STANDARD) const;
