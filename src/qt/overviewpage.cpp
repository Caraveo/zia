...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = ZiaCoinUnits::formatWithUnit(unit, amount, true, ZiaCoinUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
    ...
    ZiaCoinUnit unit{ZiaCoinUnit::ZIA};
...
{
    ZiaCoinUnit unit = walletModel->getOptionsModel()->getDisplayUnit();
    ui->labelBalance->setText(ZiaCoinUnits::formatWithPrivacy(unit, balances.balance, ZiaCoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(ZiaCoinUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, ZiaCoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(ZiaCoinUnits::formatWithPrivacy(unit, balances.immature_balance, ZiaCoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(ZiaCoinUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, ZiaCoinUnits::SeparatorStyle::ALWAYS, m_privacy));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("ZIA")
    updateDisplayUnit();
}
