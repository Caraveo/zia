...
{
    // Test regression https://github.com/ziacoin/ziacoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/ziacoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/ziacoin-core/gui/pull/568.
    // With fListen=false in ~/.config/ZiaCoin/ZiaCoin-Qt.conf and all else left as default,
    // ziacoin-qt should set both -listen and -listenonion to false and start successfully.
