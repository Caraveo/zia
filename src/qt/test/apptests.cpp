...
//! Entry point for ZiaCoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &ZiaCoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for ZiaCoinGUI tests.
void AppTests::guiTests(ZiaCoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &ZiaCoinGUI::consoleShown, this, &AppTests::consoleTests);
