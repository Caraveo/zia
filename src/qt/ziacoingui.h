...
/**
  ZiaCoin GUI main class. This class represents the main window of the ZiaCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class ZiaCoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit ZiaCoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~ZiaCoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a ziacoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, ZiaCoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed ZiaCoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(ZiaCoinUnit newUnits);
