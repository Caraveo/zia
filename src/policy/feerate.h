...
const std::string CURRENCY_UNIT = "ZIA"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    ZIA_KVB,      //!< Use ZIA/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::ZIA_KVB) const;
