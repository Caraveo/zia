...
"""Example logging ZiaCoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/ziacoind
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[ziacoind_with_usdts])
