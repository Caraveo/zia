...
When complete, it will have produced `ZiaCoin-Core.zip`.
...
apt install cpio
git clone https://github.com/ziacoin-core/apple-sdk-tools.git
...
- The Apple keyholder uses this unsigned app to create a detached signature, using the
  included script. Detached signatures are available from this [repository](https://github.com/ziacoin-core/ziacoin-detached-sigs).
